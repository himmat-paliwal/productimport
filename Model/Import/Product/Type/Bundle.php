 ...
 */
namespace Eastlane\Productimport\Model\Import\Product\Type;
...
class Bundle extends \Magento\CatalogImportExport\Model\Import\Product\Type\AbstractType
{
    ...
    /**
     * @var \Magento\BundleImportExport\Model\Import\Product\Type\Bundle\RelationsDataSaver
     */
     ...
     * @param \Magento\BundleImportExport\Model\Import\Product\Type\Bundle\RelationsDataSaver|null $relationsDataSaver
    ...
    public function __construct(
        ...
        \Magento\BundleImportExport\Model\Import\Product\Type\Bundle\RelationsDataSaver $relationsDataSaver = null,
        ...
        $this->relationsDataSaver = $relationsDataSaver
            ?: ObjectManager::getInstance()->get(\Magento\BundleImportExport\Model\Import\Product\Type\Bundle\RelationsDataSaver::class);
